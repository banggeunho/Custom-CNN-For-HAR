...
def train_val_test_split(path):
    ...
    print('Total Dataset :', len(glob(f'{src_path}/**', recursive = True))-16)
    ...
    print('Done')
    print('Train Dataset :', len(glob(src_path+'/train/**', recursive=True))-16)
    print('Val Dataset :', len(glob(src_path+'/val/**', recursive=True))-16)
    print('Test Dataset :', len(glob(src_path+'/test/**', recursive=True))-16)
